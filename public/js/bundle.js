        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'Success') {
              (0, _sweetalert.default)('Login Successful');
          ...
          case 7:
            ...
            (0, _sweetalert.default)(_context.t0.response.data.message);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _sweetalert.default)('loggedout successful'); // window.setTimeout(() => {
          ...
          case 7:
            ...
            (0, _sweetalert.default)(err.response.data.message);
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? '/api/v1/users/updateUserPassword' : '/api/v1/users/updateUser';
            _context.next = 4;
            return (0, _axios.default)({
              method: "PATCH",
              url: url,
          ...
          case 4:
            ...
            if (res.data.status === "Success") {
              (0, _sweetalert.default)("Data Update successfully"); // location.reload(true);
            }
...
},{"axios":"../../node_modules/axios/index.js","sweetalert":"../../node_modules/sweetalert/dist/sweetalert.min.js"}],"stripe.js":[function(require,module,exports) {
"use strict";
...
var stripe = Stripe('pk_test_51KPhRlFZ9H1OwUo04taHU0QMAhmprpjP4Jz5ryuFYJqhsZ3GQDzbYedsmR6T8ALnYlmaliOCloobkxFomSMftWLC00vnztLplq');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            _context.prev = 9;
            _context.t0 = _context["catch"](0);
            (0, _sweetalert.default)(_context.t0.message);
...
var updateUserPData = document.querySelector('.form-user-data');
var updateUserPassword = document.querySelector('.form-user-settings');
var logoutForm = document.querySelector('.nav__el--logout');
var getBookTour = document.getElementById('book-tour');
...
if (logoutForm) {
  logoutForm.addEventListener('click', _login.logout);
}

if (updateUserPData) {
  updateUserPData.addEventListener('submit', function (e) {
    e.preventDefault();
    var form = new FormData();
    form.append('name', document.getElementById('name').value);
    form.append('email', document.getElementById('email').value);
    form.append('photo', document.getElementById('photo').files[0]);
    (0, _updateSetting.updateUserData)(form, 'data');
  });
}
...
if (updateUserPassword) {
  updateUserPassword.addEventListener('submit', function (e) {
    e.preventDefault();
    document.querySelector('.btn--update-satus').textContent = 'Updateing...';
    var userPassword = document.getElementById('password-current').value;
    var password = document.getElementById('password').value;
    var passwordConformation = document.getElementById('password-confirm').value;
    (0, _updateSetting.updateUserData)({
      userPassword: userPassword,
      password: password,
      passwordConformation: passwordConformation
    }, 'password');
    document.querySelector('.btn--update-satus').textContent = 'Save Password';
...
if (getBookTour) {
  getBookTour.addEventListener('click', function (e) {
